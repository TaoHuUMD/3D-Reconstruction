...
class RecShapeMemoryModel(BaseModel):
    def name(self):
        return 'RecShapeMemory'
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        #to change
        parser.set_defaults(dataset_mode='DepthMemory')
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['G_L1']#, 'D_real_pred_max', 'D_real_pred_min', 'D_fake_pred_max', 'D_fake_pred_min'
    ...
    def set_input(self, input):
        ...
        #practical_batch_size_num = self.real_A.shape[0]
        self.real_B = self.real_B.view(self.real_B.shape[0]*self.opt.view_num, self.opt.input_nc, self.opt.resolution, self.opt.resolution)
        self.real_A = self.real_A_calc.view(self.real_A_calc.shape[0] * self.opt.view_num, 1, 256, 256)
